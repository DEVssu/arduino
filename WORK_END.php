...
$sql = " SELECT CLOCK_OUT FROM user_record where id = '$user_id' AND CREATE_DAY = ".$now_day." ";
$result = mysql_query($sql, $connect);
...
if($temp == null){
	$sql = " INSERT INTO user_record (ID, USER_NAME, CLOCK_OUT, CREATE_DAY) VALUES('$user_id','$user_name', ".$CLOCK_OUT.", ".$now_day.") ON DUPLICATE KEY UPDATE CLOCK_OUT=".$CLOCK_OUT." ";
	$result = mysql_query($sql, $connect);
}
